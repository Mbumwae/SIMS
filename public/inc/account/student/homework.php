...
<div class="wlsm-content-area wlsm-section-homeworks wlsm-student-homeworks">
	...
	<div class="wlsm-st-main-title">
		...
		<a href="<?php echo esc_url(add_query_arg(array('action' => 'submit-homework'), $current_page_url)); ?>" class="wlsm-btn float-right" id="wlsm-save-class-btn"><?php esc_html_e('Submit Task', 'school-management'); ?></a>
	</div>
		...
		?>
			<div>
				<span class="wlsm-font-medium wlsm-font-bold">
					<?php esc_html_e('There is no Task.', 'school-management'); ?>
				</span>
			</div>
		<?php
		}
...
<div class="wlsm-st-main-title wlsm-mt-3">
		<span>
		<?php esc_html_e( 'Recent Task Submission', 'school-management' ); ?>
		</span>
	</div>
	...
	<div class="wlsm-st-leaves-section">
		...
		<div>
			<span class="wlsm-font-medium wlsm-font-bold">
				<?php esc_html_e( "You haven't made any Task submission yet.", 'school-management' ); ?>
			</span>
		</div>
		<?php
		}
