...
$school_id_number  = $settings_dashboard['school_id_number'];

$student_name = WLSM_M_Staff_Class::get_name_text($student->student_name);
$id_number = $student->id_number;

$note = WLSM_M_Staff_Class::get_note_text($student->note);
$blood_group = WLSM_M_Staff_Class::get_blood_group_text($student->blood_group);
			...
			<div class="wlsm-flex-item wlsm-l-w-48 wlsm-mt-2">
				...
				<div class="wlsm-st-details">
					...
					<ul class="wlsm-st-details-list">
						...
						<li>
							<span class="wlsm-st-details-list-key"><?php esc_html_e('NRC Number'); ?>:</span>
							<span class="wlsm-st-details-list-value"><?php echo esc_html($id_number); ?></span>
						</li>
						...
						<li>
							<span class="wlsm-st-details-list-key"><?php esc_html_e('Academic Year', 'school-management'); ?>:</span>
							<span class="wlsm-st-details-list-value"><?php echo esc_html(WLSM_M_Session::get_label_text($student->session_label)); ?></span>
						</li>
						<li>
							<span class="wlsm-st-details-list-key"><?php esc_html_e('Year of Study', 'school-management'); ?>:</span>
							<span class="wlsm-st-details-list-value"><?php echo esc_html(WLSM_M_Class::get_label_text($student->class_label)); ?></span>
						</li>
						<li>
							<span class="wlsm-st-details-list-key"><?php esc_html_e('Programme', 'school-management'); ?>:</span>
							<span class="wlsm-st-details-list-value"><?php echo esc_html(WLSM_M_Class::get_label_text($student->section_label)); ?></span>
						</li>
						
						<li>
							<span class="wlsm-st-details-list-key"><?php esc_html_e('Sponsorship'); ?>:</span>
							<span class="wlsm-st-details-list-value"><?php echo esc_html($blood_group); ?></span>
						</li>
						
						<li>
							<span class="wlsm-st-details-list-key"><?php esc_html_e('Term'); ?>:</span>
							<span class="wlsm-st-details-list-value"><?php echo esc_html($note); ?></span>
						</li>
						<li>
