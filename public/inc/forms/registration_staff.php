			...
			<div class="wlsm-form-section">
				...
				<div class="wlsm-row">
					<div class="wlsm-form-group wlsm-col-4">
						...
						<textarea name="address" class="wlsm-form-control" id="wlsm_address" cols="30" rows="3" placeholder="<?php esc_attr_e( 'Enter Physical Address', 'school-management' ); ?>"></textarea>
					</div>
