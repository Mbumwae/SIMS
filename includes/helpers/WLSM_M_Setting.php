...
class WLSM_M_Setting {
	...
	public static function get_settings_dashboard($school_id) {
		...
		if ($settings) {
			...
			$school_id_number  = isset($settings['school_id_number']) ? $settings['school_id_number'] : '';
			$school_blood_group  = isset($settings['school_blood_group']) ? $settings['school_blood_group'] : '';
			$school_note  = isset($settings['school_note']) ? $settings['school_note'] : '';
