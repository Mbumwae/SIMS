...
add_action( 'wp_ajax_wlsm-save-school', 'wlsm_add_forward_slashes_to_id_number' );
...
add_action( 'wp_ajax_wlsm-activate-student', array( 'WLSM_Staff_General', 'activate_student' ) );
add_action( 'wp_ajax_wlsm-deactivate-student', array( 'WLSM_Staff_General', 'deactivate_student' ) );
...
// Register the AJAX callback function for fetching location options
add_action('wp_ajax_wlsm_get_location_options', array('WLSM_Staff_General', 'wlsm_get_location_options_callback'));
add_action('wp_ajax_nopriv_wlsm_get_location_options', array('WLSM_Staff_General', 'wlsm_get_location_options_callback'));
