...
<table width="100%" style="font-family: serif;" cellpadding="10">
	<tr>
		<td width="45%" style="border: 0.1mm solid #888888; "><span style="font-size: 7pt; color: #555555; font-family: sans;"></span><br />
			...
			<?php esc_html_e('Admission Number: ', 'school-management'); ?><?php echo esc_html($invoice->enrollment_number); ?><br>
			...
			<?php esc_html_e('Year of Study: ', 'school-management'); ?><?php echo esc_html(WLSM_M_Class::get_label_text($invoice->class_label)); ?><br>
			<?php esc_html_e('Programme:', 'school-management'); ?><?php echo esc_html(WLSM_M_Class::get_label_text($invoice->section_label)); ?><br>
			...
			<?php esc_html_e('Guardian\'s Name:', 'school-management'); ?><?php echo esc_html(WLSM_M_Staff_Class::get_name_text($invoice->father_name)); ?><br>
