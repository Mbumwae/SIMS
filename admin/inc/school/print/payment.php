				...
				<div class="table-responsive w-100">
					<table class="table table-bordered">
						...
						<tr>
							...
							<td><?php echo esc_html( WLSM_Config::get_money_text( $payment->due, $school_id ) ); ?></td>
						</tr>
						<tr>
						...
						<tr>
							<th><?php esc_html_e( 'Guardian\'s Name:', 'school-management' ); ?></th>
							<td><?php echo esc_html( WLSM_M_Staff_Class::get_name_text( $payment->father_name ) ); ?></td>
						</tr>
						<tr>
							<th><?php esc_html_e( 'Guardian\'s Phone:', 'school-management' ); ?></th>
						...
						<tr>
							...
							<td><?php echo esc_html( WLSM_M_Staff_Class::get_phone_text( $payment->display_name ) ); ?></td>
						</tr>
					</table>
				</div>
			</div>
