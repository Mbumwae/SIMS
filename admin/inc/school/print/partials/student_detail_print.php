			...
			<ul>
				...
				<li class="student-detail_list">
					<?php if ($school_registration_city) : ?>
						<span class="pr-5">
							<span class="wlsm-font-bold"><?php esc_html_e('District', 'school-management'); ?>:</span>
					...
					<?php if ($school_registration_state) : ?>
						<span class="pr-5">
							<span class="wlsm-font-bold"><?php esc_html_e('Province', 'school-management'); ?>:</span>
					...
					<?php if ($school_registration_country) : ?>
						<span class="pr-5">
							<span class="wlsm-font-bold"><?php esc_html_e('Nationality', 'school-management'); ?>:</span>
		...
		<div class="row mt-3">
			<div class="col mx-auto">
				<ul>
					<li class="student-detail_list">
						<span class="pr-5">
							<span class="wlsm-font-bold"><?php esc_html_e('Guardian\'s Name', 'school-management'); ?>:</span>
							<span><?php echo esc_html(WLSM_M_Class::get_label_text($student->father_name)); ?></span>
						</span>
						<span class="pr-5">
							<span class="wlsm-font-bold"><?php esc_html_e('Guardian\'s Phone', 'school-management'); ?>:</span>
							<span><?php echo esc_html(WLSM_M_Class::get_label_text($student->father_phone)); ?></span>
						</span>
						<span class="pr-5">
							<span class="wlsm-font-bold"><?php esc_html_e('Guardian\'s Occupation', 'school-management'); ?>:</span>
							<span><?php echo esc_html(WLSM_M_Class::get_label_text($student->father_occupation)); ?></span>
						</span>
					</li>
					<li class="student-detail_list">
						<span class="pr-5">
							<span class="wlsm-font-bold"><?php esc_html_e('Guardian\'s Physical Address', 'school-management'); ?>:</span>
							<span><?php echo esc_html(WLSM_M_Class::get_label_text($student->mother_name)); ?></span>
						</span>
						<span class="pr-5">
							<span class="wlsm-font-bold"><?php esc_html_e('Guardian\'s Workplace Address', 'school-management'); ?>:</span>
							<span><?php echo esc_html(WLSM_M_Class::get_label_text($student->mother_phone)); ?></span>
						</span>
						<span class="pr-5">
							<span class="wlsm-font-bold"><?php esc_html_e('Relation with the Student ', 'school-management'); ?>:</span>
