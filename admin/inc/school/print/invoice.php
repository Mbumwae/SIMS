				...
				<div class="invoice-header">
					<div class="invoice-from">
						<address class="m-t-5 m-b-5">
							...
							<strong><?php esc_html_e( 'Admission Number', 'school-management' ); ?></strong> :<br>
							<strong><?php esc_html_e( 'Phone', 'school-management' ); ?> :</strong><br>
							<Strong><?php esc_html_e( 'Email', 'school-management' ); ?> :</Strong><br>
							<strong><?php esc_html_e( 'Year of Study', 'school-management' ); ?> :</strong><br>
							<strong><?php esc_html_e( 'Programme', 'school-management' ); ?> :</strong><br>
							<strong><?php esc_html_e( 'Roll Number', 'school-management' ); ?> :</strong><br>
							<strong><?php esc_html_e( 'Guardian\'s Name', 'school-management' ); ?> :</strong>
						</address>
					</div>
					<div class="invoice-to">
						<address class="m-t-5 m-b-5">
							<?php echo esc_html( WLSM_M_Staff_Class::get_name_text( $invoice->student_name ) ); ?><br>
							<?php echo esc_html( $invoice->admission_number ); ?><br>
