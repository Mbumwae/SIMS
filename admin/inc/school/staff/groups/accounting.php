					...
					<div class="wlsm-stats-label">
						...
						printf(
							wp_kses(
								...
								__('Total Invoices <br><small class="text-secondary"> - Academic Year: %s</small>', 'school-management'),
				...
				<div class="wlsm-stats-block">
					...
					<div class="wlsm-stats-label">
						...
						printf(
							wp_kses(
								/* translators: %s: session label */
								__('Paid Invoices <br><small class="text-secondary"> - Academic Year: %s</small>', 'school-management'),
								array('small' => array('class' => array()), 'br' => array())
							),
							esc_html(WLSM_M_Session::get_label_text($current_session['label']))
						);
				...
				<div class="wlsm-stats-block">
					...
					<div class="wlsm-stats-label">
						...
						printf(
							wp_kses(
								/* translators: %s: session label */
								__('Unpaid Invoices <br><small class="text-secondary"> - Academic Year: %s</small>', 'school-management'),
								array('small' => array('class' => array()), 'br' => array())
							),
							esc_html(WLSM_M_Session::get_label_text($current_session['label']))
						);
				...
				<div class="wlsm-stats-block">
					...
					<div class="wlsm-stats-label">
						...
						printf(
							wp_kses(
								/* translators: %s: session label */
								__('Partially Paid Invoices <br><small class="text-secondary"> - Academic Year: %s</small>', 'school-management'),
								array('small' => array('class' => array()), 'br' => array())
							),
							esc_html(WLSM_M_Session::get_label_text($current_session['label']))
						);
				...
				<div class="wlsm-stats-block">
					...
					<div class="wlsm-stats-label">
						...
						printf(
							wp_kses(
								/* translators: %s: session label */
								__('Total Payments <br><small class="text-secondary"> - Academic Year: %s</small>', 'school-management'),
								array('small' => array('class' => array()), 'br' => array())
							),
							esc_html(WLSM_M_Session::get_label_text($current_session['label']))
						);
				...
				<div class="wlsm-stats-block">
					...
					<div class="wlsm-stats-label">
						...
						printf(
							wp_kses(
								/* translators: %s: session label */
								__('Payment Received <br><small class="text-secondary"> - Academic Year: %s</small>', 'school-management'),
								array('small' => array('class' => array()), 'br' => array())
							),
							esc_html(WLSM_M_Session::get_label_text($current_session['label']))
						);
				...
				<div class="wlsm-stats-block">
					...
					<div class="wlsm-stats-label">
						...
						printf(
							wp_kses(
								/* translators: %s: session label */
								__('Amount Pending<br><small class="text-secondary"> - Academic Year: %s</small>', 'school-management'),
								array('small' => array('class' => array()), 'br' => array())
							),
							esc_html(WLSM_M_Session::get_label_text($current_session['label']))
						);
				...
				<div class="wlsm-stats-block">
					...
					<div class="wlsm-stats-label">
						...
						printf(
							wp_kses(
								/* translators: %s: session label */
								__('Expense <br><small class="text-secondary"> - Academic Year: %s</small>', 'school-management'),
								array('small' => array('class' => array()), 'br' => array())
							),
							esc_html(WLSM_M_Session::get_label_text($current_session['label']))
						);
				...
				<div class="wlsm-stats-block">
					...
					<div class="wlsm-stats-label">
						...
						printf(
							wp_kses(
								/* translators: %s: session label */
								__('Income <br><small class="text-secondary"> - Academic Year: %s</small>', 'school-management'),
								array('small' => array('class' => array()), 'br' => array())
							),
							esc_html(WLSM_M_Session::get_label_text($current_session['label']))
						);
				...
				<div class="wlsm-stats-block">
					...
					<div class="wlsm-stats-label">
						...
						printf(
							wp_kses(
								/* translators: %s: session label */
								__('Daily Payments Total <br><small class="text-secondary"> - Academic Year: %s</small>', 'school-management'),
								array('small' => array('class' => array()), 'br' => array())
							),
							esc_html(WLSM_M_Session::get_label_text($current_session['label']))
						);
				...
				<div class="wlsm-stats-block">
					...
					<div class="wlsm-stats-label">
						...
						printf(
							wp_kses(
								/* translators: %s: session label */
								__('Daily Expense Total <br><small class="text-secondary"> - Academic Year: %s</small>', 'school-management'),
								array('small' => array('class' => array()), 'br' => array())
							),
							esc_html(WLSM_M_Session::get_label_text($current_session['label']))
						);
		...
		<div class="wlsm-stats-heading-block">
			<div class="wlsm-stats-heading">
				...
				printf(
					wp_kses(
						/* translators: %s: session label */
						__( 'Daily Payment History <small class="text-secondary"> - Academic Year: %s</small>', 'school-management' ),
		...
		<table class="table wlsm-stats-table wlsm-stats-payment-table">
			<thead class="bg-primary text-white">
				<tr>
					...
					<th><?php esc_html_e( 'Year of Study', 'school-management' ); ?></th>
					<th><?php esc_html_e( 'Programme', 'school-management' ); ?></th>
