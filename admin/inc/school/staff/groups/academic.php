	...
	<div class="row mt-3 mb-3">
		...
		<div class="col-sm-6 col-md-4">
			<div class="wlsm-group">
				<span class="wlsm-group-title"><?php esc_html_e( 'Year of Study & Programmes', 'school-management' ); ?></span>
		...
		<div class="col-sm-6 col-md-4">
			<div class="wlsm-group">
				<span class="wlsm-group-title"><?php esc_html_e( 'Task', 'school-management' ); ?></span>
				<div class="wlsm-group-actions">
					...
					<a href="<?php echo esc_url( $page_url_homework . '&action=save' ); ?>" class="btn btn-sm btn-outline-primary">
						<?php esc_html_e( 'Assign Task', 'school-management' ); ?>
					</a>
				</div>
			</div>
		</div>
