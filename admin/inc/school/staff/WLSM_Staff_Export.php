    ...
    public static function export_staff_students_table()
    {
        ...
        try {
            ...
            if ($filter) {
                ...
                $id_number = isset($filter->id_number) ? sanitize_text_field($filter->id_number) : '';
            }

            if (!in_array($search_students_by, array('search_by_keyword', 'search_by_class', 'search_by_id_number'))) {
            ...
            } elseif ('search_by_class' === $search_students_by) {
                if (empty($class_id)) {
                    throw new Exception(esc_html__('Please select Year of Study.', 'school-management'));
                }
            ...
            } elseif ('search_by_id_number' === $search_students_by) {
                if (empty($id_number)) {
                    throw new Exception(esc_html__('Please enter ID number.', 'school-management'));
                }
            ...
            if ($search_students_by === 'search_by_id_number') {
                $select .= ', sr.id_number';
            }
            ...
            $fields = array(
                ...
                esc_html__('NRC Number', 'school-management'),
                esc_html__('Admission Date', 'school-management'),
                esc_html__('Year of Study', 'school-management'),
                esc_html__('Programme', 'school-management'),
                ...
                esc_html__('Intake', 'school-management'),
                esc_html__('Mode of Study', 'school-management'),
                esc_html__('Sponsorship', 'school-management'),
                esc_html__('Term', 'school-management'),
                esc_html__('Constituency', 'school-management'),
                esc_html__('District', 'school-management'),
