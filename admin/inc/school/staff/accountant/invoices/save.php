				...
				<div class="wlsm-form-section">
					...
					<div class="form-row">
						...
						<div class="form-group col-md-4">
							...
							<select name="section_id" class="form-control selectpicker wlsm_section" id="wlsm_section" data-live-search="true" title="<?php esc_attr_e('All Programmes', 'school-management'); ?>" data-all-sections="1" data-fetch-students="1" data-nonce="<?php echo esc_attr(wp_create_nonce('get-section-students')); ?>">
							</select>
						</div>
