							...
							<div class="form-group col-md-12">
								...
								<div class="form-check form-check-inline">
									...
									<label class="ml-1 form-check-label wlsm-font-bold" for="wlsm_search_by_class">
										<?php esc_html_e( 'Search By Year of Study', 'school-management' ); ?>
									</label>
								</div>
								<div class="form-check form-check-inline">
						...
						<div class="wlsm-search-students wlsm-search-class-students pt-2">
							<div class="row">
								<div class="col-md-8 mb-1">
									<div class="h6">
										<span class="text-secondary border-bottom">
										<?php esc_html_e( 'Search Fee Invoice By Year of Study', 'school-management' ); ?>
										</span>
									</div>
								</div>
							</div>
							<div class="form-row">
								<div class="form-group col-md-4">
									<label for="wlsm_class" class="wlsm-font-bold">
										<?php esc_html_e( 'Year of Study', 'school-management' ); ?>:
									</label>
								...
								<div class="form-group col-md-4">
									<label for="wlsm_section" class="wlsm-font-bold">
										<?php esc_html_e( 'Programme', 'school-management' ); ?>:
									</label>
									<select name="section_id" class="form-control selectpicker" id="wlsm_section" data-live-search="true" title="<?php esc_attr_e( 'All Programmes', 'school-management' ); ?>" data-all-sections="1">
									</select>
								</div>
							</div>
						</div>
			...
			<table class="table table-hover table-bordered" id="wlsm-staff-invoices-table">
				<thead>
					<tr class="text-white bg-primary">
						...
						<th scope="col"><?php esc_html_e( 'Guardian\'s Name', 'school-management' ); ?></th>
						...
						<th scope="col"><?php esc_html_e( 'Year of Study', 'school-management' ); ?></th>
