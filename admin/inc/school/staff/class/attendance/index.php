			...
			<div class="wlsm-form-section">
				...
				<div class="form-row mt-2">
					...
					<div class="form-group col-md-4">
						...
						?>
						<select name="section_id" class="form-control selectpicker" id="wlsm_section" data-live-search="true" title="<?php esc_attr_e( 'All Programme', 'school-management' ); ?>" data-all-sections="1">
						</select>
						<?php
						}
						?>
