			...
			<table class="table table-hover table-bordered" id="wlsm-subjects-table">
				<thead>
					<tr class="text-white bg-primary">
						...
						<th scope="col" class="text-nowrap"><?php esc_html_e( 'Year of Study', 'school-management' ); ?></th>
						<th scope="col" class="text-nowrap"><?php esc_html_e( 'Lecturers', 'school-management' ); ?></th>
