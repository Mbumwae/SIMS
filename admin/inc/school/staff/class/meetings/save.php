			...
			<div class="wlsm-form-section">
				<div class="form-row">
					...
					<div class="form-group col-md-4">
						...
						<select name="section_id" class="form-control selectpicker wlsm_section" id="wlsm_section" data-live-search="true" title="<?php esc_attr_e( 'All Programmes', 'school-management' ); ?>" data-all-sections="1" data-fetch-students="1" data-skip-transferred="0" data-only-active="0" data-nonce="<?php echo esc_attr( wp_create_nonce( 'get-section-students' ) ); ?>">
					...
					<div class="form-group col-md-4">
						...
						<span class="wlsm-important">*</span><?php esc_html_e( 'Lecturer', 'school-management' ); ?>:
						</label>
						<select name="admin_id" class="form-control selectpicker" id="wlsm_teacher" data-live-search="true" title="<?php esc_attr_e( 'Select Lecturer', 'school-management' ); ?>" >	
							<option value=""></option>
							...
							<option value="<?php echo esc_attr( $teacher->ID ); ?>" <?php selected( $teacher->ID, $teacher_id, true ); ?>>
								...
								printf(
									wp_kses(
										...
										_x( '%1$s (%2$s)', 'Lecturer', 'school-management' ),
										array( 'span' => array( 'class' => array() ) )
									),
