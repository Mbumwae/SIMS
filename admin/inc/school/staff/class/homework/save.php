					...
					if ($homework) {
						printf(
							wp_kses(
								...
								__('Edit Task: %s', 'school-management'),
								array(
						...
						esc_html_e('Assign Task', 'school-management');
					}
					?>
				</span>
			</span>
			...
			<div class="wlsm-form-section">
				<div class="form-row">
					...
					<div class="form-group col-md-3">
						...
						<select name="sections[]" class="form-control selectpicker" id="wlsm_section" data-live-search="true" title="<?php esc_attr_e('Select Programme', 'school-management'); ?>" data-actions-box="true" multiple>
					...
					<div class="wlsm-attachment-box">
						<div class="wlsm-attachment-section">
							<label for="wlsm_attachments" class="wlsm-font-bold">
								<?php esc_html_e('Task', 'school-management'); ?>:
							</label>
							<?php
			...
			<div class="row mt-2">
				<div class="col-md-12 text-center">
					<button type="submit" class="btn btn-primary" id="wlsm-save-homework-btn">
						...
						<?php
							esc_html_e('Update Task', 'school-management');
						} else {
						?>
