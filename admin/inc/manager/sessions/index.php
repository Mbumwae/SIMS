		...
		<div class="wlsm-main-header card col">
			<div class="card-header">
				<h1 class="h3 text-center">
					...
					<?php esc_html_e( 'Academic Years', 'school-management' ); ?>
				</h1>
				<div class="float-md-right">
					<a href="<?php echo esc_url( $page_url . '&action=save' ); ?>" class="btn btn-sm btn-primary">
						<i class="fas fa-plus-square"></i>&nbsp;
						<?php echo esc_html( 'Add New Academic Year', 'school-management' ); ?>
					</a>
				</div>
			</div>
			<div class="card-body">
				<table class="table table-hover table-bordered" id="wlsm-sessions-table">
					<thead>
						<tr class="text-white bg-primary">
							<th scope="col"><?php esc_html_e( 'Academic Year', 'school-management' ); ?></th>
