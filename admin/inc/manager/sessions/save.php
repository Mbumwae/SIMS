			...
			<div class="col-md-12">
				<div class="wlsm-main-header card col wlsm-page-heading-box">
					...
					<?php if ( $session ) { ?>
						...
						printf(
							wp_kses(
								...
								__( 'Edit Academic Year: <span class="text-secondary">%s</span>', 'school-management' ),
								array(
					...
					<?php } else { ?>
						...
						<?php esc_html_e( 'Add New Academic Year', 'school-management' ); ?>
					<?php } ?>
					</h1>
				</div>
			</div>
								...
								<span class="float-md-right">
									<button type="submit" class="btn btn-sm btn-primary" id="wlsm-save-session-btn">
										...
										if ( $session ) {
											...
											<?php
											esc_html_e( 'Update Academic Year', 'school-management' );
										} else {
											?>
											<i class="fas fa-plus-square"></i>&nbsp;
											<?php
											esc_html_e( 'Add New Academic Year', 'school-management' );
										}
										?>
									</button>
								</span>
