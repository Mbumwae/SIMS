						...
						<div class="row">
							<div class="col-md-7">
								...
								<h2 class="h4 border-bottom pb-2">
									...
									<?php esc_html_e( 'Years of Study Assigned', 'school-management' ); ?>
								</h2>
							...
							<div class="col-md-5">
								...
								<h2 class="h4 border-bottom pb-2">
									...
									<?php esc_html_e( 'Assign Years of Study', 'school-management' ); ?>
								</h2>
								<form action="<?php echo esc_url( admin_url( 'admin-ajax.php' ) ); ?>" method="post" id="wlsm-assign-classes-form">
									...
									<div class="form-group">
										<label for="wlsm_class_search" class="font-weight-bold"><?php esc_html_e( 'Year of Study', 'school-management' ); ?>:</label>
									...
									<div class="form-group">
										<label for="wlsm_classes" class="wlsm-font-bold">
											<?php esc_html_e( 'Years of Study', 'school-management' ); ?>:
										</label>
										<select multiple name="classes[]" class="form-control selectpicker" id="wlsm_classes" data-actions-box="true" data-none-selected-text="<?php esc_attr_e( 'Assign Years of Study to the School', 'school-management' ); ?>">
