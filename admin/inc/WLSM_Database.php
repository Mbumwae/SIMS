...
class WLSM_Database
{
	public static function activation()
	{
		...
		$sql = "CREATE TABLE IF NOT EXISTS " . WLSM_ADMINS . " (
				...
				nrc_number varchar(40) DEFAULT NULL,
				nhima_number varchar(40) DEFAULT NULL,
				employee_number varchar(40) DEFAULT NULL,
				ss_number varchar(40) DEFAULT NULL,
				salary_scale varchar(60) DEFAULT NULL,
				nationality varchar(60) DEFAULT NULL,
				ministry varchar(60) DEFAULT NULL,
		...
		if (empty($row)) {
			...
			$wpdb->query("ALTER TABLE " . WLSM_STUDENT_RECORDS . " ADD consti varchar(255) DEFAULT NULL");
			$wpdb->query("ALTER TABLE " . WLSM_STUDENT_RECORDS . " ADD title varchar(255) DEFAULT NULL");
			$wpdb->query("ALTER TABLE " . WLSM_STUDENT_RECORDS . " ADD marital varchar(255) DEFAULT NULL");
		}
		...
		if (empty($row)) {
			$wpdb->query("ALTER TABLE " . WLSM_STUDENT_RECORDS . " ADD id_number varchar(20) DEFAULT NULL");
			$wpdb->query("ALTER TABLE " . WLSM_STUDENT_RECORDS . " ADD id_proof bigint(20) UNSIGNED DEFAULT NULL");
			$wpdb->query("ALTER TABLE " . WLSM_STUDENT_RECORDS . " ADD nrc bigint(20) UNSIGNED DEFAULT NULL");
			...
			$wpdb->query("ALTER TABLE " . WLSM_STUDENT_RECORDS . " ADD FOREIGN KEY (nrc) REFERENCES " . WLSM_POSTS . " (ID) ON DELETE SET NULL");
			$wpdb->query("ALTER TABLE " . WLSM_STUDENT_RECORDS . " ADD FOREIGN KEY (parent_id_proof) REFERENCES " . WLSM_POSTS . " (ID) ON DELETE SET NULL");
			$wpdb->query("ALTER TABLE " . WLSM_STUDENT_RECORDS . " ADD note varchar(20) DEFAULT NULL");
		}
...
//		Show ranks
		...
		dbDelta($sql);
                ...
                // Add fees column if not exists to HOSTELS table
