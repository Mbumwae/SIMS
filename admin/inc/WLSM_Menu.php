...
class WLSM_Menu {
	...
	public static function create_menu() {
		if ( WLSM_Helper::lm_valid() ) {
			$school_management = add_menu_page( esc_html__( 'Mongu Trades LDMS', 'school-management' ), esc_html__( 'Mongu Trades LDMS', 'school-management' ), WLSM_ADMIN_CAPABILITY, WLSM_MENU_SM, array( 'WLSM_Menu', 'school_management' ), 'dashicons-welcome-learn-more', 27 );
			...
			$schools_submenu = add_submenu_page( WLSM_MENU_SM, esc_html__( 'College Detail', 'school-management' ), esc_html__( 'College Detail', 'school-management' ), WLSM_ADMIN_CAPABILITY, WLSM_MENU_SCHOOLS, array( 'WLSM_Menu', 'schools' ) );
			add_action( 'admin_print_styles-' . $schools_submenu, array( 'WLSM_Menu', 'menu_page_assets' ) );

			$classes_submenu = add_submenu_page( WLSM_MENU_SM, esc_html__( 'Year of Study', 'school-management' ), esc_html__( 'Year of Study', 'school-management' ), WLSM_ADMIN_CAPABILITY, WLSM_MENU_CLASSES, array( 'WLSM_Menu', 'classes' ) );
			add_action( 'admin_print_styles-' . $classes_submenu, array( 'WLSM_Menu', 'menu_page_assets' ) );

			$sessions_submenu = add_submenu_page( WLSM_MENU_SM, esc_html__( 'Academic Year', 'school-management' ), esc_html__( 'Academic Year', 'school-management' ), WLSM_ADMIN_CAPABILITY, WLSM_MENU_SESSIONS, array( 'WLSM_Menu', 'sessions' ) );
			...
			if ( ! current_user_can( WLSM_ADMIN_CAPABILITY ) && count( $user_info['schools_assigned'] ) > 1 ) {
				$schools_assigned = add_menu_page( esc_html__( 'Mongu LDMS', 'school-management' ), esc_html__( 'Mongu Trades LDMS', 'school-management' ), 'read', WLSM_MENU_SCHOOLS_ASSIGNED, array( 'WLSM_Menu', 'schools_assigned' ), 'dashicons-welcome-learn-more', 27 );
			...
			if ( $current_school = $user_info['current_school'] ) {
				...
				if ( in_array( $role, array_keys( WLSM_M_Role::get_roles() ) ) ) {
					...
					// School - Menu.
					$school_staff_school_menu = add_menu_page( esc_html__( 'The Institute', 'school-management' ), esc_html__( 'The Institute', 'school-management' ), 'read', WLSM_MENU_STAFF_SCHOOL, array( 'WLSM_Menu', 'school_staff_dashboard' ), 'dashicons-building', 31 );
					...
					if ( WLSM_M_Role::check_permission( array( 'manage_classes', 'manage_subjects', 'manage_timetable', 'view_timetable',  'manage_attendance', 'manage_study_materials', 'manage_homework', 'manage_notices', 'manage_student_leaves', 'manage_events', 'manage_live_classes' ), $permissions ) ) {
						...
						$school_staff_group_academic_menu = add_menu_page( esc_html__( 'Academic', 'school-management' ), esc_html__( 'Academic', 'school-management' ), 'read', WLSM_MENU_STAFF_ACADEMIC, array( 'WLSM_Menu', 'school_staff_group_academic' ), 'dashicons-welcome-learn-more', 31 );
						...
						if ( WLSM_M_Role::check_permission( array( 'manage_classes' ), $permissions ) ) {
							...
							$school_staff_classes_submenu = add_submenu_page( WLSM_MENU_STAFF_ACADEMIC, esc_html__( 'Programmes', 'school-management' ), esc_html__( 'Year of Study & Programmes', 'school-management' ), 'read', WLSM_MENU_STAFF_CLASSES, array( 'WLSM_Menu', 'school_staff_classes' ) );
						...
						if ( WLSM_M_Role::check_permission( array( 'manage_homework' ), $permissions ) ) {
							// Class - Homework.
							$school_staff_homework_submenu = add_submenu_page( WLSM_MENU_STAFF_ACADEMIC, esc_html__( 'Task', 'school-management' ), esc_html__( 'Task', 'school-management' ), 'read', WLSM_MENU_STAFF_HOMEWORK, array( 'WLSM_Menu', 'school_staff_homework' ) );
					...
					if ( WLSM_M_Role::check_permission( array( 'manage_admissions', 'manage_students', 'manage_promote', 'manage_transfer_student', 'manage_certificates', 'send_notifications' ), $permissions ) ) {
						...
						$school_staff_group_student_menu = add_menu_page( esc_html__( 'Student', 'school-management' ), esc_html__( 'Student', 'school-management' ), 'read', WLSM_MENU_STAFF_STUDENT, array( 'WLSM_Menu', 'school_staff_group_student' ), 'dashicons-groups', 32 );
						...
						if ( WLSM_M_Role::check_permission( array( 'manage_promote' ), $permissions ) ) {
							// School - Promote.
							$school_staff_promote_submenu = add_submenu_page( WLSM_MENU_STAFF_STUDENT, esc_html__( 'Promote Student', 'school-management' ), esc_html__( 'Promote Student', 'school-management' ), 'read', WLSM_MENU_STAFF_PROMOTE, array( 'WLSM_Menu', 'school_staff_promote' ) );
					...
					if ( WLSM_M_Role::check_permission( array( 'manage_admins', 'manage_roles', 'manage_employees', 'manage_staff_attendance', 'manage_staff_leaves' ), $permissions ) ) {
						...
						$school_staff_group_administrator_menu = add_menu_page( esc_html__( 'Administrator', 'school-management' ), esc_html__( 'Administrator', 'school-management' ), 'read', WLSM_MENU_STAFF_ADMINISTRATOR, array( 'WLSM_Menu', 'school_staff_group_administrator' ), 'dashicons-businessman', 33 );
					...
					if ( WLSM_M_Role::check_permission( array( 'manage_exams' ), $permissions ) ) {
						...
						$school_staff_group_examination_menu = add_menu_page( esc_html__( 'Examination', 'school-management' ), esc_html__( 'Examination', 'school-management' ), 'read', WLSM_MENU_STAFF_EXAMINATION, array( 'WLSM_Menu', 'school_staff_group_examination' ), 'dashicons-clock', 33 );
						...
						if ( WLSM_M_Role::check_permission( array( 'manage_exams' ), $permissions ) ) {
							...
							$school_staff_exams_submenu = add_submenu_page( WLSM_MENU_STAFF_EXAMINATION, esc_html__( 'Exams', 'school-management' ), esc_html__( 'Manage Exam Type', 'school-management' ), 'read', WLSM_MENU_EXAMS_GROUP, array( 'WLSM_Menu', 'school_exams_group' ) );
							add_action( 'admin_print_styles-' . $school_staff_exams_submenu, array( 'WLSM_Menu', 'menu_page_assets' ) );
					...
					if ( WLSM_M_Role::check_permission( array( 'manage_expenses', 'manage_income', 'manage_invoices', 'manage_fees' ), $permissions ) ) {
						...
						$school_staff_group_accounting_menu = add_menu_page( esc_html__( 'Finance', 'school-management' ), esc_html__( 'Finance', 'school-management' ), 'read', WLSM_MENU_STAFF_ACCOUNTING, array( 'WLSM_Menu', 'school_staff_group_accounting' ), 'dashicons-media-spreadsheet', 33 );
						add_action( 'admin_print_styles-' . $school_staff_group_accounting_menu, array( 'WLSM_Menu', 'menu_page_assets' ) );

						$school_staff_group_accounting_submenu = add_submenu_page( WLSM_MENU_STAFF_ACCOUNTING, esc_html__( 'Finance', 'school-management' ), esc_html__( 'Dashboard', 'school-management' ), 'read', WLSM_MENU_STAFF_ACCOUNTING, array( 'WLSM_Menu', 'school_staff_group_accounting' ) );
					...
					if ( WLSM_M_Role::check_permission( array( 'manage_library' ), $permissions ) ) {
						...
						$school_staff_group_library_menu = add_menu_page( esc_html__( 'Library', 'school-management' ), esc_html__( 'Library', 'school-management' ), 'read', WLSM_MENU_STAFF_LIBRARY, array( 'WLSM_Menu', 'school_staff_group_library' ), 'dashicons-book', 34 );
				...
				if ( WLSM_M_Role::check_permission( array( 'manage_hostel' ), $permissions ) ) {
					...
					$school_staff_group_hostel_menu = add_menu_page( esc_html__( 'Hostel', 'school-management' ), esc_html__( 'Hostel', 'school-management' ), 'read', WLSM_MENU_STAFF_HOSTEL, array( 'WLSM_Menu', 'school_staff_group_hostel' ), 'dashicons-admin-home', 34 );
			...
			$school_management_menu = add_menu_page( esc_html__( 'LDMS', 'school-management' ), esc_html__( 'LDMS', 'school-management' ), WLSM_ADMIN_CAPABILITY, 'school-management-license', array( 'WLSM_Menu', 'admin_menu' ), 'dashicons-welcome-learn-more', 27 );
